...
| Nomeações | `/canhoes/admin/conteudo?view=queue` | `AdminNominationsSection` | `admin/nominations`, `admin bootstrap` |
| Categorias | `/canhoes/admin/conteudo?view=categorias` | `CategoriesAdmin` | `admin/categories`, `admin bootstrap.categories` |
| Amigos | `/canhoes/admin/membros` | `SecretSantaAdmin` + `AdminMembersSection` | `admin bootstrap.secretSanta`, `admin bootstrap.members` |
| Pendentes | `/canhoes/admin/conteudo?view=queue` | `PendingProposals` | `admin bootstrap.proposals` |
...
- Surface nova preferencial: `EventsController.*`.
