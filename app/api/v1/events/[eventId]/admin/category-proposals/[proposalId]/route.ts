...
import { updateCategoryProposal, deleteCategoryProposal } from "@/lib/domains/admin/services/proposals";
...
export async function PATCH(
  ...
  const updated = await updateCategoryProposal(eventId, proposalId, {
    name: body.name,
