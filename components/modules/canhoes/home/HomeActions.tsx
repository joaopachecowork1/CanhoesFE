...
export function ActionButton({ action, className }: Readonly<{ action: ClickableHomeAction; className?: string }>) {
...
function ActionLinkButton({
  ...
  if (action.href) {
    return (
      <Button variant={variant} className={combinedClassName} asChild>
