...
export function AdminContentTabs({
  ...
  return (
    <div className="canhoes-admin-shell-panel overflow-hidden rounded-[var(--radius-lg-token)] border border-[var(--border-paper)] bg-[var(--bg-paper)] px-2 py-2 shadow-[var(--shadow-paper)]">
          ...
          {items.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "nav-item canhoes-tap inline-flex min-h-10 items-center gap-1.5 whitespace-nowrap rounded-full border px-3 py-1.5 text-xs font-semibold transition-[background-color,border-color,color,box-shadow]",
                  "snap-start",
                  isActive
