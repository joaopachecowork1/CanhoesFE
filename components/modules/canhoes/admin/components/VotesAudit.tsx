...
function VotesAuditShell({ children }: Readonly<{ children: ReactNode }>) {
  return (
    <article className="canhoes-paper-panel canhoes-admin-shell-panel relative overflow-hidden rounded-[var(--radius-md-token)] border border-[rgba(234,179,8,0.12)] bg-[rgba(15,22,10,0.96)] px-4 py-3.5 text-[var(--ink-primary)] shadow-[0_16px_32px_rgba(0,0,0,0.14)]">
