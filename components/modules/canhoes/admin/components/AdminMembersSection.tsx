...
export function AdminMembersSection({
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="canhoes-paper-panel canhoes-admin-shell-panel border border-[rgba(234,179,8,0.12)] bg-[rgba(15,22,10,0.96)] shadow-[0_16px_32px_rgba(0,0,0,0.14)]">
