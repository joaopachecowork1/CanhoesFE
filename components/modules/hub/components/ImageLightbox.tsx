...
export function ImageLightbox({
  ...
  const lightboxContent = (
    ...
    >
      ...
      {totalSlides > 1 && (
        <div
          className="absolute left-4 top-4 z-10 rounded-full bg-black/60 px-3 py-1 text-xs font-medium text-white"
          aria-live="polite"
        >
      ...
      {/* Author info */}
      {authorName && (
        <div className="absolute left-4 bottom-4 z-10 text-xs text-white/60">
      ...
      {currentIndex > 0 && (
        <button
          ...
          className="absolute left-2 top-1/2 z-10 -translate-y-1/2 rounded-full bg-white/10 p-2 text-white shadow-lg transition-colors hover:bg-white/20"
      ...
      {currentIndex < totalSlides - 1 && (
        <button
          type="button"
          onClick={(e) => { e.stopPropagation(); setCurrentIndex((i) => i + 1); }}
          className="absolute right-2 top-1/2 z-10 -translate-y-1/2 rounded-full bg-white/10 p-2 text-white shadow-lg transition-colors hover:bg-white/20"
